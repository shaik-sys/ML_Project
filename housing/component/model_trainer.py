...
from housing.entity.artifact_entity import DataTransformationArtifact, ModelTrainingrArtifact
...
from housing.entity.model_factor import MetricInfoArtifact,ModelFactory, GridSearchedBestModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainingrArtifact:
        try:
            ...
            model_trainer_artifact=  ModelTrainingrArtifact(is_trained=True,message="Model Trained successfully",
