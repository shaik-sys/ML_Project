...
from housing.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact,ModelTrainingrArtifact,ModelEvaluationArtifact,ModelPusherArtifact
from housing.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig, ModelPusherConfig
...
from housing.entity.config_entity import ModelEvaluationConfig,ModelPusherConfig,ModelTrainingConfig
import pandas as pd
...
class Pipeline(Thread):
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact)->ModelTrainingrArtifact:
    ...
    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact,
                               data_validation_artifact: DataValidationArtifact,
                               model_trainer_artifact: ModelTrainingrArtifact) -> ModelEvaluationArtifact:
        try:
    ...
    def start_model_pusher(self,model_eval_artifact:ModelEvaluationArtifact)->ModelPusherConfig:
