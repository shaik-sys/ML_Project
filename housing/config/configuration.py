...
class Configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            ingested_data_dir = os.path.join(
                data_ingestion_artifact_dir,
                data_ingestion_info[DATA_INGESTION_DIR_INGESTED_NAME_KEY]
            )
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            # schema_file_path = data_validation_info[DATA_VALIDATION_SCHEMA_DIR_KEY]
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        try:
            ...
            transformed_train_dir = os.path.join(
                data_transformation_artifact_dir,data_transformation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],data_transformation_config_info[DATA_TRANSFORMATION_TRAIN_DIR_NAME_KEY]
                
            )
            transformed_test_dir = os.path.join(
                data_transformation_artifact_dir,data_transformation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],data_transformation_config_info[DATA_TRANSFORMATION_TEST_DIR_NAME_KEY]
    ...
    def get_model_evaluation_config(self)->ModelEvaluationConfig:
        try:
            ...
            model_evaluation_artifact_dir = os.path.join(self.training_pipeline_config.artifact_dir,MODEL_EVALUATION_ARTIFACT_DIR,)
