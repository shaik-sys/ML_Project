...
from housing.logger import get_log_dataframe,get_log_file_name,get_current_time_stamp
from housing.config.configuration import Configuration
...
def update_model_config():
    try:
        ...
        return render_template('model_update.html', result={"model_config": model_config})
...
def view_experiment_history():
    try:
        ...
        return render_template('training_history.html', context=context)
